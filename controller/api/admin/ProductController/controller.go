...
func UpdateInventory(c *gin.Context) {
	...
	valid.Numeric(c.PostForm("f"), "f").Message("请输有效整数数字")
	inv.Xxs = com.StrTo(c.PostForm("xxs")).MustInt()
	valid.Numeric(c.PostForm("xxs"), "xss").Message("请输有效整数数字")
	inv.Xs = com.StrTo(c.PostForm("xs")).MustInt()
	valid.Numeric(c.PostForm("xs"), "xs").Message("请输有效整数数字")
	inv.S = com.StrTo(c.PostForm("s")).MustInt()
	valid.Numeric(c.PostForm("s"), "s").Message("请输有效整数数字")
	inv.M = com.StrTo(c.PostForm("m")).MustInt()
	valid.Numeric(c.PostForm("m"), "m").Message("请输有效整数数字")
	inv.L = com.StrTo(c.PostForm("l")).MustInt()
	valid.Numeric(c.PostForm("l"), "l").Message("请输有效整数数字")
	inv.Xl = com.StrTo(c.PostForm("xl")).MustInt()
	valid.Numeric(c.PostForm("xl"), "xl").Message("请输有效整数数字")
	inv.Xxl = com.StrTo(c.PostForm("xxl")).MustInt()
	valid.Numeric(c.PostForm("xxl"), "xxl").Message("请输有效整数数字")
	inv.S35 = com.StrTo(c.PostForm("s35")).MustInt()
	valid.Numeric(c.PostForm("s35"), "s35").Message("请输有效整数数字")
	inv.S36 = com.StrTo(c.PostForm("s36")).MustInt()
	valid.Numeric(c.PostForm("s36"), "s36").Message("请输有效整数数字")
	inv.S37 = com.StrTo(c.PostForm("s37")).MustInt()
	valid.Numeric(c.PostForm("s37"), "s37").Message("请输有效整数数字")
	inv.S38 = com.StrTo(c.PostForm("s38")).MustInt()
	valid.Numeric(c.PostForm("s38"), "s38").Message("请输有效整数数字")
	inv.S39 = com.StrTo(c.PostForm("s39")).MustInt()
	valid.Numeric(c.PostForm("s39"), "s39").Message("请输有效整数数字")
	inv.S40 = com.StrTo(c.PostForm("s40")).MustInt()
	valid.Numeric(c.PostForm("s40"), "s40").Message("请输有效整数数字")
	inv.S405 = com.StrTo(c.PostForm("s405")).MustInt()
	valid.Numeric(c.PostForm("s405"), "s405").Message("请输有效整数数字")
	inv.S41 = com.StrTo(c.PostForm("s41")).MustInt()
	valid.Numeric(c.PostForm("s41"), "s41").Message("请输有效整数数字")
	inv.S415 = com.StrTo(c.PostForm("s415")).MustInt()
	valid.Numeric(c.PostForm("s415"), "s415").Message("请输有效整数数字")
	inv.S42 = com.StrTo(c.PostForm("s42")).MustInt()
	valid.Numeric(c.PostForm("s42"), "s42").Message("请输有效整数数字")
	inv.S425 = com.StrTo(c.PostForm("s425")).MustInt()
	valid.Numeric(c.PostForm("s425"), "s425").Message("请输有效整数数字")
	inv.S43 = com.StrTo(c.PostForm("s43")).MustInt()
	valid.Numeric(c.PostForm("s43"), "s43").Message("请输有效整数数字")
	inv.S435 = com.StrTo(c.PostForm("s435")).MustInt()
	valid.Numeric(c.PostForm("s435"), "s435").Message("请输有效整数数字")
	inv.S44 = com.StrTo(c.PostForm("s44")).MustInt()
	valid.Numeric(c.PostForm("s44"), "s44").Message("请输有效整数数字")
	inv.S445 = com.StrTo(c.PostForm("s445")).MustInt()
	valid.Numeric(c.PostForm("s445"), "s445").Message("请输有效整数数字")
	inv.S45 = com.StrTo(c.PostForm("s45")).MustInt()
	valid.Numeric(c.PostForm("s45"), "s45").Message("请输有效整数数字")
	inv.S46 = com.StrTo(c.PostForm("s46")).MustInt()
	valid.Numeric(c.PostForm("s46"), "s46").Message("请输有效整数数字")
	inv.S47 = com.StrTo(c.PostForm("s47")).MustInt()
	valid.Numeric(c.PostForm("s47"), "s47").Message("请输有效整数数字")
